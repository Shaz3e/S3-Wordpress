...
function s3_css_js(){
	...
	if( s3_option('hosted_cdn') == 1 ){
		wp_enqueue_script( 'jquery.min', '//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js', array(), '1.11.1' );	
		
		// load bootstrap library
		if( s3_option('bootstrap')  == 1){
			wp_enqueue_script( 'bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js', array(), '3.3.1' );
		}
	...
	// Load js File Locally
		...
		// load bootstrap library
		if( s3_option('bootstrap')  == 1){
			wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '3.3.1' );
		}
	...
	if( s3_option('bootstrap')  == 1){
		...
		if( s3_option('hosted_cdn') == 1 ){
			wp_enqueue_style( 'bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css', array(), '3.3.1' );
		}else{
	...
	if( s3_option('bootstrap_theme')  == 1){
		...
		if( s3_option('hosted_cdn') == 1 ){
			wp_enqueue_style( 'bootstrap-theme', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap-theme.min.css', array(), '3.3.1' );
		}else{
			// load bootstrap theme locally
			wp_enqueue_style( 'bootstrap-theme', get_template_directory_uri() . '/css/bootstrap-theme.css', array(), '3.3.1' );
		}
	}
