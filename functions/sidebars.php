...
// 6 Column Grid but content-top and content-bottom has 3 columns
	...
	if (
		...
		if($dc_sidebar_id == 'content-top' || $dc_sidebar_id == 'content-bottom'){
			if($dc_sidebar_widgets > 3){
				$dc_params[0]['before_widget'] = str_replace('class="', 'class="dc-modules3 ', $dc_params[0]['before_widget']);
			}else{
				$dc_params[0]['before_widget'] = str_replace('class="', 'class="dc-modules' . $dc_sidebar_widgets . ' ', $dc_params[0]['before_widget']);
			}
		}else{
			// all dc_sidebar_id has 6 columns
			if($dc_sidebar_widgets > 6){
				$dc_params[0]['before_widget'] = str_replace('class="', 'class="dc-modules6 ', $dc_params[0]['before_widget']);
			}else{
				$dc_params[0]['before_widget'] = str_replace('class="', 'class="dc-modules' . $dc_sidebar_widgets . ' ', $dc_params[0]['before_widget']);
			}
		}
...
if ( function_exists('register_sidebar') ) {
	...
	require_once("sidebars/topleftright.php");
